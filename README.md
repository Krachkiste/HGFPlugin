# HGFPlugin
Der Code wurde anfäglich von Krachkiste geschrieben, er ist offen für alle. ;)
Der Code ist unter der Creative Commons Lizenz Namensnennung-Nicht kommerziell-Share Alike 4.0 International, diese folgt nun.
Hinweis: Die Frameworks Bukkit(https://bukkit.org), Spigot(https://spigotmc.org) und BugeeCord(https://github.com/SpigotMC/BungeeCord/, https://github.com/SpigotMC/BungeeCord/blob/master/LICENSE) stehen unter ihren eigenen Lizenzen, diese Lizenz gilt nur für den Quelltext des Plugins, nicht für die Frameworks.
Diese Lizenz gilt nicht für Minecraft, Bukkit, Spigot.
...
Weitere Informationen zu der Lizenz: https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.de
